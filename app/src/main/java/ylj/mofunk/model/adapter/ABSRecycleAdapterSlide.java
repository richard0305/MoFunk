...
import ylj.mofunk.widget.SlidingMenu;

public abstract class ABSRecycleAdapterSlide<T> extends RecyclerView.Adapter<BaseRecycleViewHolder> {
	...
	public ABSRecycleAdapterSlide(Context context) {
		init(context, new ArrayList<T>());
	}

	public ABSRecycleAdapterSlide(Context context, T[] objects) {
		init(context, Arrays.asList(objects));
	}

	public ABSRecycleAdapterSlide(Context context, List<T> objects) {
