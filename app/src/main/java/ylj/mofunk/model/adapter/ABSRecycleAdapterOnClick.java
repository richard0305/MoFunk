...
public abstract class ABSRecycleAdapterOnClick<T> extends RecyclerView.Adapter<BaseRecycleViewHolder> implements View.OnClickListener{
	...
	public ABSRecycleAdapterOnClick(Context context) {
		init(context, new ArrayList<T>());
	}

	public ABSRecycleAdapterOnClick(Context context, T[] objects) {
		init(context, Arrays.asList(objects));
	}

	public ABSRecycleAdapterOnClick(Context context, List<T> objects) {
