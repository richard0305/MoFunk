...
public abstract class ABSRecycleAdapter<T> extends RecyclerView.Adapter<BaseRecycleViewHolder> {
	...
	public ABSRecycleAdapter(Context context, T[] objects) {
		init(context, Arrays.asList(objects));
	}

	public ABSRecycleAdapter(Context context, List<T> objects) {
