...
public class FragmentUtils {
     ...
     * @param fragmentManager fragment������
     * @param containerId     ����Id
     * @param hideFragment    Ҫ���ص�fragment
     ...
     *
     * @param fragment      fragment
     * @param isIncludeSelf �Ƿ����Fragment���Լ�
     */
     ...
     * �滻fragment
     *
     * @param srcFragment  Դfragment
     * @param destFragment Ŀ��fragment
     * @param isAddStack   �Ƿ������ջ
     * @return Ŀ��fragment
     */
     ...
     *
     * @param fragmentManager fragment������
     * @return {@code true}: ��ջ�ɹ�<br>{@code false}: ��ջʧ��
     */
     ...
     *
     * @param hideFragment ��Ҫ���ص�Fragment
     * @param showFragment ��Ҫ��ʾ��Fragment
     * @return ��ʾ��Fragment
     */
    ...
    private static Fragment operateFragment(@NonNull FragmentManager fragmentManager,
        ...
        if (sharedElements == null || sharedElements.length == 0) {
            ...
            for (SharedElement element : sharedElements) {// ��ӹ���Ԫ�ض���
    ...
    /**
     * ��ȡĿ��fragment��ǰһ��fragment
     *
     * @param destFragment Ŀ��fragment
     * @return Ŀ��fragment��ǰһ��fragment
     */
    ...
    /**
     * ����fragment���˼�
     * <p>���fragmentʵ����OnBackClickListener�ӿڣ�����{@code true}: ��ʾ�����ѻ��˼��¼�����֮��û����</p>
     * <p>����ʾ����FragmentActivity</p>
     *
     * @param fragment fragment
     * @return �Ƿ����ѻ����¼�
     */
