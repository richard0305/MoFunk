 ...
 * </pre>
 */
public final class LogUtilsTools {

    private LogUtilsTools() {
    ...
    public static class Builder {
        ...
        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                LogUtilsTools.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                LogUtilsTools.sGlobalTag = "";
                sTagIsSpace = true;
            }
            return this;
        }
        ...
        public Builder setLogSwitch(boolean logSwitch) {
            LogUtilsTools.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(boolean log2FileSwitch) {
            LogUtilsTools.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Builder setBorderSwitch(boolean borderSwitch) {
            LogUtilsTools.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setLogFilter(@TYPE int logFilter) {
            LogUtilsTools.sLogFilter = logFilter;
            return this;
        }
    }
